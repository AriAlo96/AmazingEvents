...
function printCards(containerCardsPastEvents, cards) {
    let placeCard = document.getElementById(containerCardsPastEvents)
    placeCard.innerHTML = (cards)
}


let cards = createCardsList(eventList)
printCards("containerCardsPastEvents", cards)
